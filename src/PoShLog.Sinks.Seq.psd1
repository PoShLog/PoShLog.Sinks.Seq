...
RootModule = 'PoShLog.Sinks.Seq.psm1'
...
GUID = '56f8bfaa-ea01-4de4-a597-6c37be15c7c6'
...
Description = 'PoShLog.Sinks.Seq is extension module for PoShLog core library - https://www.powershellgallery.com/packages/PoShLog.
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'seq','Log','Logging','Serilog','File','filelog','logfile','error-log','console','event','serilog-sink','serilog-for-powershell','wrapper','sinks','PSEdition_Desktop','PSEdition_Core','Windows','Linux','MacOS'
        ...
        ReleaseNotes = 'https://github.com/PoShLog/PoShLog.Sinks.Seq/blob/master/releaseNotes/v1.0.0.md'
